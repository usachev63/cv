...
\cventry{2025--2026}{Kaspersky Lab (1 year)}{}{}{}{
...
\cvlistitem{\textbf{Silver medal, International Olympiad in Informatics (IOI), 2021}}
\cvlistitem{\textbf{Gold medal}, Romanian Master of Informatics (RMI), 2020}
\cvlistitem{\textbf{Gold medal}, International Autumn Tournament of Informatics (IATI), 2020}
\cvlistitem{ \textbf{Winner}, Russian National
...
\section{Talks}
\cvlistitem{\textbf{OFFZONE 2025} ``Making our path to multi-step-vulnerabilities''. \href{https://www.youtube.com/watch?v=cnQSnFc1VjI}{\color{blue}YouTube}, \href{https://vkvideo.ru/playlist/-172362100_25/video-172362100_456239309?linked=1}{\color{blue}VK Video}}

\section{Papers}
\cvlistitem{``\textit{Static Analyzer for Array Recognition in C Programs for Fuzzing}'', Trudy ISP RAN 2026 --- in review stage}

\section{Pet-projects}

\cvlistitem{\href{https://github.com/usachev63/SaveWarpTool}{\color{blue}\textbf{SaveWarpTool}} and \href{https://github.com/usachev63/SaveWarpFinder}{\color{blue}\textbf{SaveWarpFinder}} --- tooling for Half-Life speedrunning, implemented in C++}
