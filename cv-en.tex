...
\cvlistitem{System programming: program analysis, compiler internals, testing, including fuzzing, appsec, \ldots}
\cvlistitem{C++ programming}
\cvlistitem{Other languages: Lua, Java, Kotlin, Go, Python}
