...
\cventry{2025--2026}{Kaspersky Lab (1 год)}{}{}{}{
...
\cvlistitem{\textbf{Серебряная медаль, международная олимпиада по информатике (IOI), 2021}}
...
\cvlistitem{\textbf{OFFZONE 2025} <<Протаптываем дорожку к multi-step-уязвимостям>>. \href{https://www.youtube.com/watch?v=cnQSnFc1VjI}{\color{blue}YouTube}, \href{https://vkvideo.ru/playlist/-172362100_25/video-172362100_456239309?linked=1}{\color{blue}VK Видео}}

\section{Статьи}

\cvlistitem{<<\textit{Статический анализатор для распознавания массивов в С-программах для задач фаззинга}>>, Труды ИСП РАН 2026 --- на этапе рецензии}

\section{Пет-проекты}

\cvlistitem{\href{https://github.com/usachev63/SaveWarpTool}{\color{blue}\textbf{SaveWarpTool}} и \href{https://github.com/usachev63/SaveWarpFinder}{\color{blue}\textbf{SaveWarpFinder}} --- тулинг для скоростного прохождения игры Half-Life, реализованный на C++}
